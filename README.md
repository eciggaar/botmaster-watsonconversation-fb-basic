...
5. Click "Download as JSON".
  ...
  ![Conversation instance](https://github.com/eciggaar/botmaster-watsonconversation-basic/blob/master/readmeimages/instance.png?raw=true{:height="470px" width="281px"})
